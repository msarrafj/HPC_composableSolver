...
Formulation: mixed RT0 formulation 
...
#velocity
if element == 'T3':
	vSpace = FunctionSpace(mesh,"RT",1)
else:
	vSpace = FunctionSpace(mesh, "RTCF", 1)
#pressure
...
file = File('Output/v1_2D_RT0.pvd')
file.write(v1sol)

file = File('Output/v2_2D_RT0.pvd')
file.write(v2sol)

file = File('Output/p1_2D_RT0.pvd')
file.write(p1sol)

file = File('Output/p2_2D_RT0.pvd')
file.write(p2sol)
...
# interpolate and project are the same.
p1_ex = project(p1_exact, pSpace)
v1_ex = project(v1_exact, vSpace)
p2_ex = project(p2_exact, pSpace)
v2_ex = project(v2_exact, vSpace)

#file = File('Output/v1ex_2D.pvd')
#file.write(v1_ex)

#file = File('Output/v2ex_2D.pvd')
#file.write(v2_ex)

#file = File('Output/p1ex_2D.pvd')
#file.write(p1_ex)

#file = File('Output/p2ex_2D.pvd')
#file.write(p2_ex)
