...
#file = File('Output/v1_2D_DG.pvd')
#file.write(v1sol)

#file = File('Output/v2_2D_DG.pvd')
#file.write(v2sol)

#file = File('Output/p1_2D_DG.pvd')
#file.write(p1sol)

#file = File('Output/p2_2D_DG.pvd')
#file.write(p2sol)
...
#file = File('results_2D/v1ex_2D_DG.pvd')
#file.write(v1_ex)
p2_ex = interpolate(p2_exact, pSpace)
#file = File('results_2D/p2ex_2D_DG.pvd')
#file.write(p2_ex)
